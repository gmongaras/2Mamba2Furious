...
def main():
    ...
    wandb_name = "small_2048sl_gpu_32bs__squared__sm_norm__A_mask_type_neg_softplus__in_conv_k_2__dt_on_values__no_kernel"
    log_steps=10
    use_amp=True
    ...
    clipping_value=None
    weight_decay=0.01
    model_save_path = "models/small_2048sl_gpu_32bs__squared__sm_norm__A_mask_type_neg_softplus__in_conv_k_2__dt_on_values__no_kernel"
    ...
    checkpoint_path = "models/small_2048sl_gpu_32bs__squared__sm_norm__A_mask_type_neg_softplus__in_conv_k_2__dt_on_values__no_kernel/"
