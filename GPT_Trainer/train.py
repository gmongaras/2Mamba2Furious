...
def main():
    ...
    wandb_name="Ker_4096L_Exp_NoPE_Conv_AMask_AMaskTypeNEGSOFTPLUS_NOAMaskBias_AMaskValueDiscretizationDT_SMNorm"
    log_steps=10
    use_amp=True
    ...
    clipping_value=None
    weight_decay=0.01
    model_save_path = "models/Ker_4096L_Exp_NoPE_Conv_AMask_AMaskTypeNEGSOFTPLUS_NOAMaskBias_AMaskValueDiscretizationDT_SMNorm"
    # model_save_path = "models/del"
    num_save_steps = 1_000
    keep_dataset_in_mem = False
    model_max_length = 2048*2
    test_per = 0.001
    ...
    checkpoint_path = "models/Ker_2048L_Exp_NoPE_Conv_AMask_AMaskTypeNKer_4096L_Exp_NoPE_Conv_AMask_AMaskTypeNEGSOFTPLUS_NOAMaskBias_AMaskValueDiscretizationDT_SMNormEGSOFTPLUS_NOAMaskBias_AMaskValueDiscretizationDT_SMNorm/"
